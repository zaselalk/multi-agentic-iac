...
def GPT5(preprompt, prompt, client):
    messages = [
        {"role": "system", "content": preprompt},
        {"role": "user", "content": prompt},
    ]
...
def _gemini_generate(preprompt, prompt, model_name: str):
...
# Gemini wrapper functions added
# gemini-1.0-pro
def gemini(preprompt, prompt):
    return _gemini_generate(preprompt, prompt, "gemini-1.0-pro")

# gemini-2.5-pro
def gemini_2_5(preprompt, prompt):
    return _gemini_generate(preprompt, prompt, "gemini-2.5-pro")

# gemini-2.0-flash
def gemini_2_flash(preprompt, prompt):
    return _gemini_generate(preprompt, prompt, "gemini-2.0-flash")
